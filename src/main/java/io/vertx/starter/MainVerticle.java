...
public class MainVerticle extends AbstractVerticle {
	...
	public void start(Future<Void> startFuture) throws Exception {
		...
		// ar is of type AsyncResult<Void>. AsyncResult<T> is used to pass the
		// result of an asynchronous processing and may
		// either yield a value of type T on success or a failure exception if
	...
	private Future<Void> prepareDatabase() {
		...
		// AsyncResult<SQLConnection>. It must then be tested to see if the
		// connection could be established or not (AsyncResult is actually a
		// super-interface of Future).
